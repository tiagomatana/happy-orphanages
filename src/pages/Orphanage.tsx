...
export default function Orphanage() {
  ...
  useEffect(()=> {
    api.get(`orphanages/${params.id}`).then(respone => {
      setOrphanage(respone.data)
    });
  }, [params.id]);
          ...
          <div className="images">
            {
              orphanage.images.map((image, index) => {
                return (
                  <button className={activeImageIndex === index ? "active": ""} key={image.id} type="button" onClick={() => setActiveImageIndex(index)}>
